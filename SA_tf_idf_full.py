...
### Question 1, termes complets
## Calcul du facteur idf pour chaque mot
# Création des listes et de la constante D
ListeTermes = ["Lucie", "crayon", "roule", "maison", "rouge", "policier", "congé", "soulier"]
df = [1, 2, 1, 2, 3, 1, 1, 1]
D = 4
...
D1sansidf = [1, 1, 1, 0, 0, 0, 0, 0]
D2sansidf = [0, 0, 0, 1, 1, 0, 0, 0]
D3sansidf = [0, 1, 0, 1, 2, 0, 0, 0]
D4sansidf = [0, 0, 0, 0, 2, 1, 1, 1]
...
# "maison" et "rouge" nous donnerait le vecteur [0, 0, 0, 1, 1, 0, 0, 0], mais ce vecteur est exactement le document 2, donc son vecteur sera utilisé
