...
# Déterminer le facteur d'amplification
FacteurAmplification = 2.5
...
# Création de l'algorithme du filtrage collaboratif utilisateur-utilisateur utilisant Pearson
algo = KNNWithMeans(sim_options={'name': 'pearson', 'user_based': True}, verbose = False)
algo.fit(trainset)
...
print("L’erreur de validation croisée (All-But-1 MAE) en utilisant l’algorithme utilisateur-utilisateur"
      "\npar corrélation de Pearson, avec amplification des similitudes de 2.5, est de " + str(AllBut1))